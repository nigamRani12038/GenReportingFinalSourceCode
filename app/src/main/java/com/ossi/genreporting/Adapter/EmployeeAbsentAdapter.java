...
public class EmployeeAbsentAdapter extends RecyclerView.Adapter<EmployeeAbsentAdapter.MyViewHolder> implements Filterable {

    FragmentActivity context;
    private ArrayList<AbsentStatusResponse> object;
    AbsentStatusResponse exp;
    public EmployeeAbsentAdapter(ArrayList<AbsentStatusResponse> list_holiday, Activity context) {
    ...
    @Override
    public EmployeeAbsentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.all_employee_current_status_item, parent, false);

        return new EmployeeAbsentAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(EmployeeAbsentAdapter.MyViewHolder holder, int position) {
    ...
    public void add(AbsentStatusResponse s) {
        object.add(s);
   ...
   public void updateList(ArrayList<AbsentStatusResponse> list) {
       this.object = list;
       notifyDataSetChanged();
   }}
