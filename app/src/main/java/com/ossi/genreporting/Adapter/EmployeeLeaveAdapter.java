...
public class EmployeeLeaveAdapter extends RecyclerView.Adapter<EmployeeLeaveAdapter.MyViewHolder> implements Filterable {

    FragmentActivity context;
    private ArrayList<LeaveStatusREsponse> object;
    LeaveStatusREsponse exp;

    public EmployeeLeaveAdapter(ArrayList<LeaveStatusREsponse> list_holiday, Activity context) {
    ...
    @Override
    public EmployeeLeaveAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.all_employee_current_status_item, parent, false);

        return new EmployeeLeaveAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(EmployeeLeaveAdapter.MyViewHolder holder, int position) {
    ...
    public void add(LeaveStatusREsponse s) {
        object.add(s);
    ...
    public void updateList(ArrayList<LeaveStatusREsponse> list) {
        this.object = list;
        notifyDataSetChanged();
    }
}
