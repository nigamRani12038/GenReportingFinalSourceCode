...
public class ViewAllCommingRequestAdmin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_view_all_comming_request_admin, container, false);
        ...
        // department_hr = pref.getString("show_req_from_hr", " ");
        ...
        if (bundle != null) {
            ...
            department = bundle.getString("show_req_from_hr");
                ...
                if (my_req_res != null && my_req_res.size() > 0) {
                    ...
                    for (int i = 0; i < my_req_res.size(); i++) {
                        ...
                        request_list.add(model);
                            ...
                            Toast.makeText(getActivity(), "No Request for approval", Toast.LENGTH_SHORT).show();
                        }
                    }
