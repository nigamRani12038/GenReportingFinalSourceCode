...
public class HrTablayoutFragment extends Fragment implements View.OnClickListener {
    private View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_hr_tablayout, container, false);
...
//get_event();
    ...
    public class PagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            ...
            switch (position) {
                case 0:
                    LeaveStatusForHr leaveFragmentHome1 = new LeaveStatusForHr();
                    return leaveFragmentHome1;
                /*case 1:
