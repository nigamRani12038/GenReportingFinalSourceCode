...
public class WfhApprovalFragment extends Fragment {
View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_wfh_approval, container, false);
                ...
                if (my_req_res != null && my_req_res.size() > 0) {
                    ...
                    for (int i = 0; i < my_req_res.size(); i++) {
                        ...
                        if (resPonse.equalsIgnoreCase("success")){
                            ...
                            Toast.makeText(getActivity(), "No Request for WFH Approval ", Toast.LENGTH_SHORT).show();
                        }
                    }
